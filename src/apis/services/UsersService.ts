...
export class UsersService {
   ...
   * @throws ApiError
   */
  public static usersControllerDeleteMany({ id }: { id: Array<string> }): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/api/user',
      query: {
   ...
   * @throws ApiError
   */
  public static usersControllerGetItem({ id }: { id: string }): CancelablePromise<UserDetailDto> {
    return __request(OpenAPI, {
      method: 'GET',
      url: '/api/user/{id}',
      path: {
