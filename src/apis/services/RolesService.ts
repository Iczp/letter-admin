...
export class RolesService {
   ...
   * @throws ApiError
   */
  public static rolesControllerDeleteMany({ id }: { id: Array<string> }): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/api/roles',
      query: {
   ...
   * @throws ApiError
   */
  public static rolesControllerGetItem({ id }: { id: string }): CancelablePromise<RoleDetailDto> {
    return __request(OpenAPI, {
      method: 'GET',
      url: '/api/roles/{id}',
      path: {
