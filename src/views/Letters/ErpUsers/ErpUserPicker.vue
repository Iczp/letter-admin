...
const setCurrent = (row?: ErpUsersDto) => {
  singleTableRef.value!.setCurrentRow(row);
};
const selectable = (row: ErpUsersDto) => !['1', '2'].includes(row.id!);
const handleCurrentChange = (row: ErpUsersDto | undefined) => {
...
const selectionChange = (row: Array<ErpUsersDto>) => {
...
<template>
  <Dialog v-model="visible" :width="width" :maxHeight="height" :title="title">
    ...
    >
      ...
      <el-table-column property="departmentName" label="Address" show-overflow-tooltip>
